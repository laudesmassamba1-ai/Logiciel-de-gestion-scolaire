...
from core.config import (
    JOURS, CRENEAUX, PERIODES, ROLE_LABELS,
    C_PRIMARY, C_TEXT, C_TEXT_SECONDARY, C_TEXT_MUTED, C_EMPTY_STATE,
    C_BORDER, C_CARD, C_BG, C_BG_ALT, C_PRIMARY_LIGHT, C_PRIMARY_BG,
    C_DANGER, C_DANGER_BG, C_DANGER_BORDER, C_SUCCESS,
    STYLE_BTN_PRIMARY, STYLE_BTN_SECONDARY, STYLE_BTN_SUCCESS,
    STYLE_BTN_DANGER, STYLE_BTN_ADD, STYLE_CARD, STYLE_SELECTOR,
    STYLE_HEADER_TITLE, STYLE_HEADER_SUBTITLE, STYLE_EMPTY_STATE,
    STYLE_STATUS, STYLE_TABLE,
)
...
def notes(page, ctx):
    ...
    # --- TAB 1: SAISIE PAR MATIERE (classe + matiere -> tous les eleves) ---
    header1 = QHBoxLayout()
    ...
    # --- TAB 2: SAISIE PAR ELEVE (classe + eleve -> toutes les matieres) ---
    header2 = QHBoxLayout()
